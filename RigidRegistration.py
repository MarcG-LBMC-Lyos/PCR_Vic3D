...
class RigidRegistration(EMRegistration):
    """
    Redefines RigidRegistration class from pycpd to avoid error raising issues in __init__, remove the size degree of
    freedom and to add self.q to self.get_registration_parameters.
    """
    ...
    def get_registration_parameters(self):
        ...
        """
        return self.s, self.R, self.t, self.q
